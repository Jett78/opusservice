    ...
    <main>
      <div className="w-11/12 mx-auto my-20" ref={aboutContainer}>
        <section className="flex flex-wrap justify-between items-start ">
          ...
          <div className="sm:max-w-[50%] md:sticky top-[10em]">
            ...
            <h1 className="header md:text-5xl  text-3xl font-bold leading-[1.1em]">
          ...
          <div className="about-img-animate sm:max-w-[50%]">
            ...
            <p className="about-desc font-medium md:text-xl text-lighttext my-6">
            ...
            <div className="text-black grid grid-cols-2 items-center justify-center gap-10 py-10">
              {details.map((item, index) => (
                <div key={index} className="grid place-items-center">
                  <h2
                    className="font-extrabold md:text-6xl sm:text-5xl text-4xl"
                    ref={counterRef}
                  >
                    {item.num}
                  </h2>
